 ...
 * Title: Movements.java
 * Description: stores the list of checker movements that a player can perform as a result of a dice roll.
 * */
...
public class Movements implements Iterable<Integer>, Iterator<Integer> {
    // a [4,4] dice roll would allow the movements 4,4,4,4
    // a [2,1] dice roll would allow the movements 2,1 or 1,2
